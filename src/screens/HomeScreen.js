...
import NicNacAppBar from '../components/NicNacAppBar';
import NicNacSideDrawer from '../components/NicNacSideDrawer';
import DrawerHeader from '../components/DrawerHeader'; // Adjust the path as necessary


const HomeScreen = ({ toggleTheme, currentTheme }) => {
